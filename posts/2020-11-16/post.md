...
Taking a *wild* guess, this is probably encoded with [ASCII](https://en.wikipedia.org/wiki/Ascii), the a simple text encoding. Let me just consult my ASCII table for the numbers 52 and 84, and we get...
`4 T`
